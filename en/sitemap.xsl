  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <script type="text/javascript" src="/osdp-temp/core/assets/vendor/jquery/jquery.min.js"/>
        <script type="text/javascript" src="/osdp-temp/modules/contrib/simple_sitemap/xsl/jquery.tablesorter.min.js"/>
        <script type="text/javascript" src="/osdp-temp/modules/contrib/simple_sitemap/xsl/parser-date-iso8601.min.js"/>
        <script type="text/javascript" src="/osdp-temp/modules/contrib/simple_sitemap/xsl/simple_sitemap.xsl.js"/>
        <link href="/osdp-temp/modules/contrib/simple_sitemap/xsl/simple_sitemap.xsl.css" type="text/css" rel="stylesheet"/>
      </head>
      <body>
        <h1>Sitemap file</h1>
